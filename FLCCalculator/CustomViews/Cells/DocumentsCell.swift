...
final class DocumentsCell: UICollectionViewCell {
    ...
    private let iconView = FLCRoundButton(image: FLCIcon.document.icon, tint: .flcOrange, cornerStyle: .capsule, type: .standard)
    private let downloadPercentageLabel = FLCTitleLabel(color: .flcOrange, textAlignment: .right, size: 15)
    private let downloadedDocumentIcon = FLCRoundButton(image: FLCIcon.checkmark.icon, tint: .flcOrange, cornerStyle: .capsule, imageSize: 13, type: .standard)
