...
class ProfileSettingsVC: UIViewController {
    ...
    private let birthdayTextField = FLCNumberTextField(smallLabelPlaceholderText: "Дата рождения", smallLabelFontSize: 16, keyboardType: .numberPad, fontSize: 18, fontWeight: .bold)
    ...
    private let companyNameTextField = FLCNumberTextField(smallLabelPlaceholderText: "Название компании", smallLabelFontSize: 16, keyboardType: .default, fontSize: 18, fontWeight: .bold)
    private let innTextField = FLCNumberTextField(smallLabelPlaceholderText: "ИНН", smallLabelFontSize: 16, keyboardType: .numberPad, fontSize: 18, fontWeight: .bold)
    private let dtTextField = FLCNumberTextField(smallLabelPlaceholderText: "Количество оформленных ДТ за год", smallLabelFontSize: 16, keyboardType: .numberPad, fontSize: 18, fontWeight: .bold)
    ...
    private func configureContainerView() {
        containerView.addSubviews(personalSectionLabel, nameTextField, birthdayTextField, contactsSectionLabel, phoneTextField, emailTextField, companySectionLabel, companyNameTextField, innTextField, dtTextField, privacyPolicyAgreenmentTextViewLabel, saveButton, exitButton, deleteButton)
    ...
    private func configureInnTextField()  {
        ...
        NSLayoutConstraint.activate([
            innTextField.topAnchor.constraint(equalTo: companyNameTextField.bottomAnchor, constant: padding / 2),
            innTextField.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: padding),
            innTextField.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -padding),
            innTextField.heightAnchor.constraint(equalToConstant: textFieldsHeight)
        ])
    }
    
    private func configureDtTextField()  {
        dtTextField.delegate = self
        
        NSLayoutConstraint.activate([
            dtTextField.topAnchor.constraint(equalTo: innTextField.bottomAnchor, constant: padding / 2),
            dtTextField.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: padding),
            dtTextField.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -padding),
            dtTextField.heightAnchor.constraint(equalToConstant: textFieldsHeight)
        ])
    }
    
    private func configurePrivacyPolicyAgreenmentTextViewLabel() {
        privacyPolicyAgreenmentTextViewLabel.delegate = self
        privacyPolicyAgreenmentTextViewLabel.setStyle(color: .lightGray, textAlignment: .left, fontSize: 15)
        
        NSLayoutConstraint.activate([
            privacyPolicyAgreenmentTextViewLabel.topAnchor.constraint(equalTo: dtTextField.bottomAnchor, constant: padding),
            privacyPolicyAgreenmentTextViewLabel.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: padding * 1.5),
            privacyPolicyAgreenmentTextViewLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -padding * 1.5)
        ])
    }
    ...
    private func configureSaveButton() {
        ...
        NSLayoutConstraint.activate([
            saveButton.topAnchor.constraint(equalTo: privacyPolicyAgreenmentTextViewLabel.bottomAnchor, constant: padding),
    ...
    private func configureExitButton() {
        ...
        NSLayoutConstraint.activate([
            exitButton.topAnchor.constraint(equalTo: saveButton.bottomAnchor, constant: padding * 3),
